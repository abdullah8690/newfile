...
//
//    $result = mysqli_query ( $conQ, 'select * from products where id=' . $_GET ['id'] );
...
//$allitem = '';
//$item = array();
//$query = "SELECT  orders (customer_id, date) VALUES ('$customer_id', CURDATE())";
//$stmt =$conQ->prepare($query);
//$stmt->execute();
//$result = $stmt->get_result();
//while ($row = $result->fetch_assoc()){
//    $customer_id +=$row['total_price'];
//    $item[] = $row['item_qty'];
//    echo $customer_id;
//
//}